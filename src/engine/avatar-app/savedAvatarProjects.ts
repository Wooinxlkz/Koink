import type { AvatarAnimationTimeline } from '@koink/avatar-core'

export const AVATAR_PROJECTS_STORAGE_KEY = 'koink-avatar-projects-v1'
export const ACTIVE_AVATAR_PROJECT_STORAGE_KEY = 'koink-avatar-active-project-v1'
