...
import type { AvatarCoatPattern, AvatarView } from '@koink/avatar-core'
import type { AvatarCoatPatternAlgorithm, AvatarCoatPatternLightPatchShape } from '@koink/avatar-core'
