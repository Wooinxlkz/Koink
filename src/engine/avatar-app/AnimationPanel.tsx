...
const PRESET_DRAG_TYPE = 'application/x-koink-avatar-animation-preset'
const PRESET_DRAFT_DRAG_TYPE = 'application/x-koink-avatar-animation-preset-draft'
const CLIP_DRAG_TYPE = 'application/x-koink-avatar-animation-clip'
const TRACK_DRAG_TYPE = 'application/x-koink-avatar-animation-track'
