...
import { createDefaultAvatarDefinition } from '@koink/avatar-core'
import type { AvatarAnimationLibrary, AvatarDefinition } from '@koink/avatar-core'
import App from '../avatar-app/App'
import { AvatarLocaleProvider } from '../avatar-app/avatarLocale'
...
export const AvatarEditor = forwardRef<AvatarEditorHandle, AvatarEditorProps>(function AvatarEditor({
  ...
  return (
    <div
      {...divProps}
      ref={containerRef}
      className={`koink-avatar-editor${className == null ? '' : ` ${className}`}`}
      tabIndex={-1}
    >
