import { getAvatarPalette } from '@koink/avatar-core'
import type { AvatarDefinition } from '@koink/avatar-core'
import {
  applyAvatarEntityPalette, createAvatarEntityParts, getAvatarEntityPresetScene
} from '../avatar-app/avatarEntityPresets'
import {
...
} from '../avatar-app/avatarBreedTemplates'
import { AVATAR_ANIMAL_BREED_TEMPLATES, resolveAvatarAnimalBreedTemplate } from '../avatar-app/avatarSpeciesBreeds'
